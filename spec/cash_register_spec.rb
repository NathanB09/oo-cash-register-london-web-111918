describe 'CashRegister' do
  ...
  describe '#void_last_transaction' do
    ...
    it 'subtracts the last transaction from the total if the quantity is > 1' do
      cash_register.add_item("tomato", 1.76, 3)
      expect{cash_register.void_last_transaction}.to change{cash_register.total}.from(5.28).to(0.0)
    end
  end
end
